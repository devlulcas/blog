...
thumbnail: /pictures/react_bonk.png
alt: reactjs
tags:
  - dev
  - reactjs
...
- Um site de consulta de pokémons utilizando a PokeApi. O usuário digita o nome do pokémon e um card é mostrado com suas informações.

<Pic
	src="pokedex_react.jpg"
	alt="react pokedex"
	width="974"
	height="657"
	align="center"
...
<Pic
	src="f/orm_react.webp"
	alt="react login form"
	width="1600"
	height="900"
	align="center"
/>
...
O JSX não é compreendido pelo navegador, então compiladores irão tranformar esse JSX em funções Javascript válidas.
